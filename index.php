            ...
            <div class="container homepage">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <p><a class="btn btn-default" href="News.php" role="button" style="color: #e74c3c">Check latest news &raquo;</a></p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fa fa-circle fa-stack-2x"></i>
                        ...
                        <p><a class="btn btn-default" href="Gossip.php" role="button" style="color: #e74c3c">Start chatting &raquo;</a></p>
                    </div>
                </div>
            </div>
        </div>
